...
def vector_size(adc: "RADCIP") -> int64: ...
def get_imds(adc: "RADCIP", eris: Optional[Callable]=None) -> ndarray: ...
def get_diag(adc: "RADCIP", kshift: int, M_ij: Optional[ndarray]=None, eris: Optional[Callable]=None) -> ndarray: ...
def matvec(adc: "RADCIP", kshift: int, M_ij: Optional[ndarray]=None, eris: Optional[Callable]=None) -> Callable: ...
def get_trans_moments(adc: "RADCIP", kshift: int) -> ndarray: ...
def get_trans_moments_orbital(adc: "RADCIP", orb: int, kshift: int) -> ndarray: ...
def renormalize_eigenvectors(adc: "RADCIP", kshift: int, U: ndarray, nroots: int = 1) -> ndarray: ...
def get_properties(adc: "RADCIP", kshift: int, U: ndarray, nroots: int = 1) -> Tuple[ndarray, ndarray]: ...
