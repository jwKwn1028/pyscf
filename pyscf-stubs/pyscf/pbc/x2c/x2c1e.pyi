...
class X2C1E_GSCF(x2c._X2C_SCF):
    __name_mixin__: str
    with_x2c: Incomplete
    def __init__(self, mf: Union[KGHF, KGKS, GKS, GHF]) -> None: ...
...
class SpinOrbitalX2C1EHelper(sfx2c1e.PBCX2CHelper):
    ...
    def dump_flags(self, verbose: None=None) -> "SpinOrbitalX2C1EHelper": ...

def get_1c_pvxp(cell, kpts=None): ...
def get_pbc_pvxp(mydf: Union[GDF, AFTDF], kpts: Optional[ndarray]=None) -> ndarray: ...
