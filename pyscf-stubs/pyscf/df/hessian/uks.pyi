...
def make_h1(hessobj: "Hessian", mo_coeff: ndarray, mo_occ: ndarray, chkfile: None=None, atmlst: Optional[range]=None, verbose: Optional[Logger]=None) -> Tuple[ndarray, ndarray]: ...
